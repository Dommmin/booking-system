...
export default function Brands() {
   ...
   const [url, setUrl] = useState('/api/v1/admin/services');
   ...
   return (
      <>
         <h1 className="p-2 text-3xl font-bold">Services</h1>
         <div className="mx-auto flex max-w-6xl justify-end p-2 sm:px-6 lg:px-8">
            <Link href={'/admin/services/create'} className="btn btn-success btn-wide text-white">
               Create Service
            </Link>
         </div>
